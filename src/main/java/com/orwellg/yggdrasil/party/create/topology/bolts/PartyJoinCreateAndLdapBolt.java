...
public class PartyJoinCreateAndLdapBolt extends JoinFutureBolt<Party> {
	...
	// */
	// public static final String EVENT_SUCCESS_STREAM =
	// "party-create-and-ldap-success-stream";
	// /**
	// * Define the name of the error stream
	// */
	// public static final String EVENT_ERROR_STREAM =
	// "party-create-and-ldap-error-stream";
	...
	protected void join(Tuple input, String key, String processId, Party eventData) {
		...
		try {
			...
			// Get (and init if they weren't before) topology application-wide params. Tries
			// to connect to zookeeper:
			TopologyConfigWithLdap topologyConfig = (TopologyConfigWithLdap) TopologyConfigWithLdapFactory
					.getTopologyConfig();
	...
	public void declareFieldsDefinition() {
		...
		// addFielsDefinition(EVENT_ERROR_STREAM, Arrays.asList(new String[] {"key",
		// "processId", "eventName", "result"}));
	}
