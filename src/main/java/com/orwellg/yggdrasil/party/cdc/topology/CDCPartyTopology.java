...
//import com.orwellg.yggdrasil.party.cdc.topology.bolts.PartyKafkaCDCProcessBolt;
//
///**
...
//
//	public static final String TOPOLOGY_NAME = "cdc-party";
//
...
//	public static final String CREATE_PARTY_COMPONENT_ID = "cdc-party";
...
//				new PartyKafkaCDCProcessBolt(), config.getEventProcessHints());
//		kafkaEventProcess
...
//		// CDC action bolt
//
//		GBolt<?> partyJoinBolt = new GRichBolt(JOIN_COMPONENT_ID, new CDCPartyBolt(JOIN_COMPONENT_ID), 10);
